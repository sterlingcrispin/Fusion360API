    ...
    try: 
        ...
        for j in range(tubeCount):
            ...
            for i in range(splineSegments):
                ...
                taper1 = math.sin((j/tubeCount+0.05)*3.14)  * bowlAmplitude
                taper2 = math.sin((i/splineSegments+0.05)*3.14) * bowlAmplitude
                
                length = ( tubeLength  / splineSegments) 
                
                x =  xstep 
                y = taper1 * taper2 * -1 -taper1 
                z = length * i 
        ...
        radius =  (minLength / splineSegments) * 4
